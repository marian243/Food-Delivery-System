    ...
    <table id="menutable">
                    ...
                    <div id="items">
                       ...
                       <script>
                            ...
                            var url = "http://localhost/web/cc.php";
                    ...
                    <div class="footer-in-main">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-a">
                                <h3>About Us</h3>
                                <p>Crimson Cup provides the great tasting gourmet coffee roasted right from the Buckeye land of Columbus, Ohio. There by Columbus Coffee proudly serves Crimson Cup coffee and tea.We want you to know . . . what those big coffee chains want you to think you’re getting. Only for real.</p>
                                <ul class="socials-box footer-socials pull-left">
                                    <li>
                                        <a href="https://www.facebook.com/crimsoncupbd/">
