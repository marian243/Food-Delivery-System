                ...
                <div class="banner-static">
                    <div class="banner-text">
                        <div class="banner-cell">
                            <h1>Dine with us  <span class="typer" id="some-id" data-delay="200" data-delim=":" data-words="Friends:Family:Officemates" data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-90 p-b-30">
				<form class="login100-form validate-form">
					...
					<div>
						<a href="https://www.facebook.com/" class="btn-login-with bg1 m-b-10">
							<i class="fa fa-facebook-official"></i>
							Login with Facebook
						</a>

						<a href="https://twitter.com/Twitter" class="btn-login-with bg2">
					...
					<div class="flex-col-c p-t-224">
						...
						<a href="signup1.php" class="txt3 bo1 hov1">
							Sign up now
						</a>
					</div>
