...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <p> Easy Cafe is a platform for foodies who are willing to order food and take reservations in their desired restaurant.We provide convenient and easy service to customers.</p>
    ...
    <div class="special-menu pad-top-100 parallax">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <h2 class="block-title color-white text-center"> Special Offers </h2>
                        <h5 class="title-caption text-center"> Check out the latest offers in your favourite restaurant before the offer ends!</h5>
                    </div>
                                ...
                                <a href="#" class="item-hover">
                                    <div class="item-info">
                                        <div class="headline">
                                            Chicken Steak Meal
                                            <div class="line"></div>
                                            <div class="dit-line">Chicken Steak Meal at Chillox </div>
                                        </div>
                                    </div>
                                </a>
                                <div class="item-img">
                                ...
                                <a href="#" class="item-hover">
                                    <div class="item-info">
                                        <div class="headline">
                                            Bar B Q PIZZA
                                            <div class="line"></div>
                                            <div class="dit-line">2 medium size pizza at Alfresco at 400/=</div>
                                        </div>
                                    </div>
                                </a>
                                <div class="item-img">
                                ...
                                <a href="#" class="item-hover">
                                    <div class="item-info">
                                        <div class="headline">
                                            Shwarma
                                            <div class="line"></div>
                                            <div class="dit-line">Buy 1 get 1 offer at Alfresco at 250/=</div>
                                        </div>
                                    </div>
                                </a>
                                <div class="item-img">
                                ...
                                <a href="#" class="item-hover">
                                    <div class="item-info">
                                        <div class="headline">
                                            Chicken Poutine
                                            <div class="line"></div>
                                            <div class="dit-line">Chillox is introducing a range of delicious poutine</div>
                                        </div>
                                    </div>
                                </a>
                                <div class="item-img">
                                ...
                                <a href="#" class="item-hover">
                                    <div class="item-info">
                                        <div class="headline">
                                             Buffet Offer
                                            <div class="line"></div>
                                            <div class="dit-line">Buffet offer for two at 1000/=</div>
                                        </div>
                                    </div>
                                </a>
                                <div class="item-img">
    ...
    <div id="search" class="s01">
      <form>
          <link href="css/main.css" rel="stylesheet" />
        <fieldset>
          <legend>Look for places to eat</legend>
        </fieldset>
        <div class="inner-form">
          <div><a href="BurgerKing.php"><img src="images/download.png"></a></div>
          <div><a href="Dominos.php"><img src="images/dominos.png"></a></div>    
          <div><a href="CrimsonCup.php"><img src="images/cc.jpg"></a></div>    
          
        </div>
        <div class="inner-form">
          <div><a href="chillox.html"><img src="images/chillox.jpg"></a></div>    
          <div><a href="alfresco.html"><img src="images/alfresco.png"></a></div>
          <div><a href="royalbuffet.php"><img src="images/royalbuffet.jpg"></a></div>
        </div>
      </form>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            ...
                            <p> Subscribe to get the latest news and updates on food and resturants</p>
                        </div>
                        <form>
                            <input type="email" placeholder="Enter your e-mail id">
                            <a href="home.php" class="orange-btn">Subscribe</a> 
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="footer-box-c">
                                ...
                                <p>
                                    ...
                                    <span>United City, Madani Ave, Dhaka 1212</span>
                                </p>
                                <p>
